const NAV_BY_ROLE = {
  admin: [
    { key: "adminpanel", label: "Dashboard", href: "./admin", icon: "fa-table" },
    { key: "empresas", label: "Empresas", href: "./empresas", icon: "fa-building" },
    { key: "users", label: "Usuarios", href: "./users", icon: "fa-users" },
    { key: "conf", label: "Configuración", href: "./conf", icon: "fa-cog" },
  ],
  user: [
    { key: "paneluser", label: "Mis reportes", href: "./user", icon: "fa-file-lines" },
    // Agrega esta línea justo aquí 👇
    { key: "empresas", label: "Mis empresas", href: "./empresas", icon: "fa-building" },
  ],
};
